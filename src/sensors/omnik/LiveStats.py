...
if s is None:
    ...
    syslog.syslog('Cound not open socket')
    sys.exit(1)
...
if not options.csv:
    ...
    # print "Time,Id,Temp,VPV1,VPV2,VPV3,IPV1,IPV2,IPV3,IAC1,IAC2,IAC3,VAC1,VAC2,VAC3,FAC1,PAC1,FAC2,PAC2,FAC3,PAC3,ETODAY,ETOTAL,HTOTAL"
