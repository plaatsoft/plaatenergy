...
if value[0] == 'true':
  ...
  while stack_teller < len(stack):
     ...
     if stack[stack_teller][0:9] == "1-0:1.8.1":
        low_used = float(stack[stack_teller][10:19])
     elif stack[stack_teller][0:9] == "1-0:1.8.2":
        normal_used = float(stack[stack_teller][10:19])
     elif stack[stack_teller][0:9] == "1-0:2.8.1":
        low_delivered = float(stack[stack_teller][10:19])
     elif stack[stack_teller][0:9] == "1-0:2.8.2":
        normal_delivered = float(stack[stack_teller][10:19])
     elif stack[stack_teller][0:9] == "1-0:1.7.0":
        power = int(float(stack[stack_teller][10:17])*1000)
     elif stack[stack_teller][0:9] == "1-0:2.7.0":
        power_delivered = int(float(stack[stack_teller][10:17])*1000)
