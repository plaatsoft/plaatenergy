...
function plaatenergy_webcam_page() {
  ...
  $device3 = plaatenergy_db_get_config_item('webcam_present', WEBCAM_3);
  ...
  $page .= '<style>.image{-moz-animation: none; -o-animation: none; -webkit-animation: none; animation: none}></style>';
	...
	if ($device3=="true" ) {
		$page .= '&nbsp;'; 
		$page .= '<img class="image" src="webcam/image3.jpg" alt="" id="webcam3" width="480" height="360" >';
	    $page .= '<script>window.setInterval(function() { document.getElementById("webcam3").src = "webcam/image3.jpg?random="+new Date().getTime(); }, 500);</script>';
	}
