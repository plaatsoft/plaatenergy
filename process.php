...
$sql = 'select elektra_prijs,start_dal, start_piek, start_gas FROM config';
$result = $conn->query($sql);
$config = $result->fetch_assoc();

$dal = $config['start_dal'];
$piek = $config['start_piek']; 
$gas = $config['start_gas']; 
$dalterug = 0;
$piekterug = 0;
$etotal = 0;
$round = 3;
