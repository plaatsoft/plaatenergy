...
INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'database_version', '0.5', SYSDATE(), 'Current database version');

INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'energy_meter_reading_low', '0', SYSDATE(),'Energy meter reading - low tariff (kwh)');
INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'energy_meter_reading_normal', '0', SYSDATE(), 'Energy meter reading - normal tariff (kwh)');
INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'gas_meter_reading', '0', SYSDATE(), 'Gas meter reading (m3)');

INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'energy_price', '0', SYSDATE(),'Energy price per kwh');
INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'gas_price', '0', SYSDATE(),'Gas price per m3');

INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'energy_use_forecast', '2899', SYSDATE(), 'Energy use forecast (kWh)');
INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'energy_delivery_forecast', '3012', SYSDATE(), 'Energy delivery forecast (kWh)');
INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'gas_use_forecast', '956', SYSDATE(), 'Gas use forecast (m3)');

INSERT INTO config2 (`id`, `token`, `value`, `date`, `description`) VALUES (NULL, 'energy_meter_present', 'true', SYSDATE(), 'Energy meter present');
